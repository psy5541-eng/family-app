                      ...
                      <div className="flex items-center gap-3 flex-shrink-0 ml-2">
                        <button
                          ...
                          onClick={() => {
                            ...
                            const intentUri = `intent://place?lat=${ev.latitude}&lng=${ev.longitude}&name=${encodeURIComponent(ev.placeName!)}&appname=com.runningcrew.app#Intent;scheme=nmap;package=com.nhn.android.nmap;S.browser_fallback_url=${encodeURIComponent(webUrl)};end`;
                  ...
                  <div className="flex items-center gap-3 flex-shrink-0 ml-2">
                    ...
                    <button
                      ...
                      onClick={(e) => {
                        ...
                        const intentUri = `intent://place?lat=${latitude}&lng=${longitude}&name=${encodeURIComponent(placeName)}&appname=com.runningcrew.app#Intent;scheme=nmap;package=com.nhn.android.nmap;S.browser_fallback_url=${encodeURIComponent(webUrl)};end`;
                        window.location.href = intentUri;
                      }}
                      className="flex items-center gap-1 text-green-600"
                    >
